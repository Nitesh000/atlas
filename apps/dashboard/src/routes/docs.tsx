      ...
      <div className="grid gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>The fastest way to add RAG chat to your frontend.</CardDescription>
          </CardHeader>
...
<span className="text-blue-400">&lt;script</span> <span className="text-green-300">src</span>=<span className="text-yellow-300">"https://atlas.com/embed.js"</span>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Directly query the chat pipeline from your backend.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-sm text-foreground/80">
...
curl -X POST https://api.atlas.com/v1/chat \
  ...
  -d <span className="text-yellow-300">{"'"}&#123; "message": "How do I authenticate?" &#125;{"'"}</span>
              </pre>
            </div>
          </CardContent>
        </Card>
